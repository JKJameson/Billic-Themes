...
class Themes {
	...
	function admin_area() {
		...
		if (isset($_GET['Name'])) {
			...
			echo '<li class="nav-item"><a href="#" class="nav-link' . ($current_module == 'Header' ? ' active' : '') . '" data-toggle="tab" onClick="loadSettingsPage(\'Header\')">Header</a></li>';
			echo '<li class="nav-item"><a href="#" class="nav-link' . ($current_module == 'Footer' ? ' active' : '') . '" data-toggle="tab" onClick="loadSettingsPage(\'Footer\')">Footer</a></li>';
			echo '<li class="nav-item"><a href="#" class="nav-link' . ($current_module == 'CSS' ? ' active' : '') . '" data-toggle="tab" onClick="loadSettingsPage(\'CSS\')">CSS</a></li>';
			echo '<li class="nav-item"><a href="#" class="nav-link' . ($current_module == 'Admin_Header' ? ' active' : '') . '" data-toggle="tab" onClick="loadSettingsPage(\'Admin_Header\')">Admin Header</a></li>';
			echo '<li class="nav-item"><a href="#" class="nav-link' . ($current_module == 'Admin_Footer' ? ' active' : '') . '" data-toggle="tab" onClick="loadSettingsPage(\'Admin_Footer\')">Admin Footer</a></li>';
			echo '<li class="nav-item"><a href="#" class="nav-link' . ($current_module == 'Admin_CSS' ? ' active' : '') . '" data-toggle="tab" onClick="loadSettingsPage(\'Admin_CSS\')">Admin CSS</a></li>';
			echo '<li class="nav-item">';
			if ($_GET['Name'] == 'Default') {
				echo '<button class="btn btn-danger disabled">Default theme can not be saved</button>';
			} else {
				echo '<button class="btn btn-default disabled" id="saveThemeBtn" onClick="saveTheme()"><i class=\"icon-save-disk\"></i> No Changes</button>';
			}
			echo '</li>';
			echo '</ul>';
